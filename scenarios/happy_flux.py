...
class HappyFluxScenario(Scenario):
    """
    Cenário de Fluxo Feliz:
    Authorize -> TransactionEvent
    """
    
    _happy_flux_parameters = [
    ...
    def __init__(self):
        super().__init__("happy_flux", self._happy_flux_parameters)
